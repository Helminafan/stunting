...
var FullCalendar = (function (e) {
            ...
            (function (e) {
                ...
                t =
                    !0 === e
                        ...
                        : [];
                return (
                    (t = t.map((e) => Object.assign(Object.assign({}, Jn), e))),
                    t
                );
            })(e),
            null,
    ...
    class hr {
        ...
        splitProps(e) {
            let t = this.getKeyInfo(e),
                ...
                l = {};
            this.eventUiBuilders = Dt(
                t,
                (e, t) => this.eventUiBuilders[t] || nn(fr)
            );
            for (let n in t) {
                let c = t[n],
                    d = s[n] || ur,
    ...
    class ji {
        ...
        toRects() {
            ...
            for (let i = 0; i < n; i += 1) {
                ...
                for (let e of n)
                    r.push(
                        Object.assign(Object.assign({}, e), { levelCoord: s })
                    );
            }
            return r;
        }
        ...
        updateSize() {
            ...
            if (i) {
                let s = r.getBoundingClientRect(),
                    o = n
                        ? Ie(t, ".fc-scrollgrid").getBoundingClientRect().top
                        : i.top,
    ...
    class po extends Xr {
        ...
        updateParentEl() {
            this.linkEl &&
                (this.parentEl = Ie(this.linkEl, ".fc-view-harness"));
        }
    }
    function mo(e) {
        return e.text;
    ...
    function vo(e) {
        if (e.allDayDate)
            return { start: e.allDayDate, end: Pt(e.allDayDate, 1) };
        let { hiddenSegs: t } = e;
        return {
            start: yo(t),
            ...
            (e) =>
                (function (e, t, n, r, i) {
                    ...
                    return {
                        ...
                        buttonTextDefault:
                            d(i) || e.defaults.buttonText || d(En) || e.type,
                        buttonTitleOverride:
                            u(r) || u(n) || e.overrides.buttonHint,
                        buttonTitleDefault:
                            u(i) || e.defaults.buttonHint || u(En),
                    };
                })(e, s, t, n, r)
        );
    }
    ...
    function Qo(e, t, n, r) {
        ...
        switch (t.type) {
            ...
            case "REMOVE_EVENT_SOURCE":
                return (
                    (s = e), (o = t.sourceId), At(s, (e) => e.sourceId !== o)
                );
            case "PREV":
            case "NEXT":
            case "CHANGE_DATE":
            ...
            propSetHandlers: {
                dateProfile: function (e, t) {
                    t.emitter.trigger(
                        "datesSet",
                        Object.assign(
                            Object.assign({}, ki(e.activeRange, t.dateEnv)),
                            { view: t.viewApi }
                        )
                    );
                },
        ...
        processRawCalendarOptions(e, t) {
            let { locales: n, locale: r } = xn([En, e, t]),
                ...
                l = (this.currentCalendarOptionsRefiners = Object.assign(
                    Object.assign(
                        Object.assign(
                            Object.assign(Object.assign({}, bn), Sn),
                            An
                        ),
                        a.listenerRefiners
                    ),
            ...
            for (let e in s)
                s[e] === l[e] || (Dn[e] && Dn[e](s[e], l[e]))
                    ...
                    : (s[e] === this.currentCalendarOptionsInput[e] ||
                      (Dn[e] &&
                          Dn[e](s[e], this.currentCalendarOptionsInput[e]))
    ...
    function Ma(e) {
        ...
        return new Bi(
            Object.assign(
                Object.assign(
                    { timeZone: En.timeZone, calendarSystem: "gregory" },
                    e
                ),
                { locale: t }
            )
    ...
    function qa(e, t) {
        return (
            (!e && !t) ||
            (Boolean(e) === Boolean(t) && Ti(e.dateSpan, t.dateSpan))
        );
    }
    function Ya(e, t) {
        let n = {};
        ...
        constructor(e) {
            super(e),
                ...
                (this.handlePointerDown = (e) => {
                    ...
                    let c =
                        n.isValidSegDownEl(t) && !Ie(t, ".fc-event-resizer");
                    r.setIgnoreMove(!c),
                        (this.isDragging =
                            c &&
            ...
            return p(
                ...
                (s, a) =>
                    p(
                        ...
                        !a.isDisabled &&
                            (t.showDayNumber || so(i) || t.forceDayTop)
                            ? p(
                                  "div",
            ...
            if (c)
                for (let f of t) {
                    ...
                    y &&
                        (a.isRtl
                            ? ((E = 0),
                              (b = c.lefts[t.lastCol] - c.lefts[t.firstCol]))
                            : ((b = 0),
                              (E =
                        ...
                        h.push(
                            p(
                                "div",
                                {
                                    ...
                                    ref: u
                                        ? null
                                        : this.segHarnessRefs.createRef(m),
                                    style: {
                                        visibility: v ? "" : "hidden",
            ...
            if (this.needsScrollReset && this.props.clientWidth) {
                const e = (function (e, t) {
                    ...
                    t.currentRangeUnit.match(/year|month/) &&
                        (n = e.querySelector(
                            `[data-date="${Kt(t.currentDate)}-01"]`
                        ));
                    n ||
                        (n = e.querySelector(
                            `[data-date="${Jt(t.currentDate)}"]`
                        ));
                    return n;
    ...
    class Hl {
        ...
        computeTimeTop(e) {
            let t,
                ...
                s = r.els.length,
                o =
                    (e.milliseconds - vt(i.slotMinTime)) /
                    vt(this.slotDuration);
            return (
                (o = Math.max(0, o)),
                (o = Math.min(s, o)),
                (t = Math.floor(o)),

        ...
        <div class="flex flex-col">
            <form action="" method="GET">   
                ...
                <div class="relative">
                    ...
                    <input type="search" name="search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-[#D981B4] rounded-lg bg-gray-50 focus:ring-[#D981B4] focus:border-[#D981B4] dark:bg-white dark:border-gray-300 dark:placeholder-gray-400 dark:text-gray-900 dark:focus:ring-[#D981B4] dark:focus:border-[#D981B4] mr-2 mb-2" value="{{old('search')}}" placeholder="Cari data anak" required>
                    <button type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-[#D981B4] hover:bg-[#D981B4] focus:ring-4 focus:outline-none focus:ring-[#D981B4] font-medium rounded-lg text-sm px-4 py-2 dark:bg-[#D981B4] dark:hover:bg-[#D981B4] dark:focus:ring-[#D981B4]">Search</button>
                </div>
            </form>
        </div>
    </div>

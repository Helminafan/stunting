        ...
        <section class="bg-white dark:bg-white">
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                ...
                <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div class="text-center text-gray-500 dark:text-gray-400">
                        <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="{{ asset('kader/foto/helmi.jpg') }}" alt="Avatar">
                        <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-900">
                    ...
                    <div class="text-center text-gray-500 dark:text-gray-400">
                        <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="{{ asset('kader/foto/ajril.JPG') }}" alt="Avatar">
                        <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-900">
                    ...
                    <div class="text-center text-gray-500 dark:text-gray-400">
                        <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="{{ asset('kader/foto/virgi.jpg') }}" alt="vir">
                        <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-900">

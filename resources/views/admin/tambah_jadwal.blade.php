        ...
        <div class="container">
            ...
            <div class="bg-[#D981B4] mx-5 rounded-xl py-5 mb-20">
                ...
                <form action="{{route('storeKalender')}}" method="POST">
                    ...
                    <div class=" mx-3">
                        <button type="submit"
                            class=" w-full text-white bg-[#865BF4] hover:bg-red-600 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Simpan</button>
                    </div>
                </form>
            </div>
        </div>

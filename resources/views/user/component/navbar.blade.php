<section class="tombol  fixed w-3/4 bottom-3 left-1/2 -translate-x-1/2 ">
    <div class="bg-white rounded-3xl text-[30px] shadow-[0px_-3px_20px__rgba(0,0,0,0.5)]  py-4 grid grid-cols-3 gap-1">

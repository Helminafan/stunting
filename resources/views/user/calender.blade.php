            ...
            <div class="card mb-32">
                ...
                <div class="bg-white py-3 rounded-b-lg">
                    ...
                    <div class="flex mb-3 mx-auto justify-center">
                        <div class="flex w-1/2 items-center pl-4 border  rounded">
                            ...
                            <label for="bordered-checkbox-1" class="w-full py-4 ml-2 text-sm font-medium text-gray-900">Tidak</label>
                        </div>
                        <div class="flex w-1/2 items-center pl-4 border  rounded">
                            <input checked id="bordered-checkbox-2" type="checkbox" value="" name="bordered-checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                            <label for="bordered-checkbox-2" class="w-full py-4 ml-2 text-sm font-medium text-gray-900">Iya</label>
                        </div>
                    </div>
                    <div class="flex">

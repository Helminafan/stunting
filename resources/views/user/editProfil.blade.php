    ...
    <section>
        <div class="container">
            ...
            <div class="bg-green-200 mx-5 rounded-xl py-5">
                ...
                <div class=" mx-3">
                    <button type="button"
                        class=" w-full text-white bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2">Simpan</button>
                </div>
